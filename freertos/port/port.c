...
#define tmrITR_PRIORITY itrHIGH_PRIORITY
...
/*
 * ISR placed on the hight priority vector.  This calls the appropriate ISR for
 * the actual interrupt.
 */
...
static void prvLowInterrupt( void )
{
    _asm goto prvLowPrioISR _endasm
}
#pragma code

#pragma interruptlow prvLowPrioISR
void prvLowPrioISR(void)
{
...
unsigned char ucByte;
    ...
    /* Make timer interrupt LOW priority */
    IPR1bits.TMR1IP = tmrITR_PRIORITY;
