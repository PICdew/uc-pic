...
#define	itrLOW_PRIORITY             ( 0 )
#define	itrHIGH_PRIORITY            ( 1 )

/* Critical section management. */
#define portDISABLE_INTERRUPTS()	do { INTCONbits.GIEH = 0; /* INTCONbits.GIEL = 0; */ } while (0)
#define portENABLE_INTERRUPTS()		do { INTCONbits.GIEH = 1; /* INTCONbits.GIEL = 1; */ } while (0)
